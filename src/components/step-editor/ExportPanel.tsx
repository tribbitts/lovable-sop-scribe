          ...
          <Card className="bg-blue-900/20 border-blue-600/50">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-3 pt-2">
                ...
                {/* HTML Customization Section - Front and Center for Business Tier */}
                <div className="mt-4 p-4 bg-gradient-to-r from-purple-900/20 to-blue-900/20 border border-purple-600/50 rounded-lg">
                  <h4 className="text-purple-200 font-medium text-sm mb-3 flex items-center gap-2">
                    <Sparkles className="h-4 w-4" />
                    Business Tier: Professional Customization
                  </h4>
                  ...
                  <div className="space-y-3">
                    ...
                    {/* Accent Color */}
                    <div className="flex items-center justify-between">
                      <Label className="text-purple-200 text-xs">Accent Color</Label>
                      <div className="flex items-center gap-2">
                        <input
                          type="color"
